...
class Subject:
    ...
    def __str__(self):
        info = f'{self.sjno} {self.sjname} {self.sjdesc} {self.sjsect} {self.prof}'
...
tahee = Student(201350050,'태희','경기도 고양시','1985.3.22',
                '컴퓨터',504)
print(tahee)

lee = Professor('이순신','프로그래밍','[java,python]','컴퓨터')
print(lee)

programming = Subject('0205','프로그래밍','자바 프로그래밍','컴퓨터',301)
print(programming)

computer = Department('컴퓨터공학', '123-4567-8912','E동 2층',504)
print(computer)