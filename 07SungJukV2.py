...
print(f'이름 : {names[1]}, 국어: {kors[1]}, 영어: {engs[1]}, 수학: {mats[1]}')
print(f'총점: {tots[1]}, 평균: {avgs[1]:.1f}')
print(f'이름 : {names[2]}, 국어: {kors[2]}, 영어: {engs[2]}, 수학: {mats[2]}')
print(f'총점: {tots[2]}, 평균: {avgs[2]:.1f}')
